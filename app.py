...
- three_reasons phải có chính xác 3 phần tử, MỖI phần tử đánh giá đúng 1 trong 3 chỉ số
  bắt buộc theo thứ tự cố định:
      ...
      (2) Đánh giá closing cash: lấy closing cash được tính toán ở trên, không được tự nghĩ ra số liệu hay tự ý thay đổi số liệu. 
          - Nếu closing cash < 550 triệu: Nội dung bắt buộc sinh ra: "Projected Closing Cash hiện tại là {projected_closing_cash}, bé hơn mốc an toàn 550 triệu VND (Kích hoạt RR-002). Dự án đang có rủi ro về khả năng thanh khoản."
          - Nếu closing cash > 550 triệu: Nội dung bắt buộc sinh ra: "Projected Closing Cash hiện tại là {projected_closing_cash}, lớn hơn hoặc bằng mốc 550 triệu VND. Khả năng thanh khoản của dự án được đảm bảo."
